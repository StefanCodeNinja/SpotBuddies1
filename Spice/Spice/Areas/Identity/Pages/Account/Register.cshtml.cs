        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.FrontDescUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.FrontDescUser));
                    }
                    ...
                    {
                        if (role == SD.FrontDescUser)
                        {
                            await _userManager.AddToRoleAsync(user, SD.FrontDescUser);
                        }
                        else
                        {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Please confirm your account by Spot Buddies by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
